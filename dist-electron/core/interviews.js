...
exports.INTERVIEW_MODULES = void 0;
exports.buildVoiceInterviewPrompt = buildVoiceInterviewPrompt;
const purpose_js_1 = require("./purpose.js");
const safety_js_1 = require("./safety.js");
const identity_js_1 = require("./identity.js");
exports.INTERVIEW_MODULES = [
    {
        id: "origins",
...
function buildVoiceInterviewPrompt(args) {
    const memories = args.memories.length > 0
        ? args.memories
            .map((memory, index) => `[M${index + 1}] ${memory.title}: ${memory.content} (confiança: ${Math.round(memory.confidence * 100)}%)`)
            .join("\n")
