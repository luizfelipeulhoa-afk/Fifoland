import type { AdviceMode, MemoryRecord, PersuasionContract } from "../shared/types.js";

export function demoAdvisorResponse(args: {
  text: string;
  mode: AdviceMode;
  ...
  const modeLine: Record<AdviceMode, string> = {
