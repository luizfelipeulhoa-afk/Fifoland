import type { PersonalCalendarEvent, TaskRecord } from "../shared/types";

export type ProactiveSignal = {
  kind: "overdue-task" | "upcoming-event";
  fingerprint: string;
  title: string;
  body: string;
  view: "today" | "calendar";
...
export function findProactiveSignal(
  tasks: TaskRecord[],
  events: PersonalCalendarEvent[],
  reference = new Date(),
  eventWindowMinutes = 30
